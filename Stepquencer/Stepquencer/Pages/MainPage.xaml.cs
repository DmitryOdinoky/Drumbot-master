...
namespace Stepquencer
{
    ...
    public partial class MainPage : ContentPage
    {
        ...
        int miniGridWidth = 37;                         // width of each minigrid
        int miniGridHeight = 34;                        // height of each minigrid
        ...
        {
            await DisplayAlert("Welcome to Drumbot!", "Tap on a square to place a sound, and hit play to hear your masterpiece.", "Get Started");
        }
