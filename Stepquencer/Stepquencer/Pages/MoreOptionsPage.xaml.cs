...
namespace Stepquencer
{
    ...
    public partial class MoreOptionsPage : ContentPage
    {
        ...
        public MoreOptionsPage(MainPage passedpage)
        {
            ...
            Button testButton = new Button { Text = "test", Style = buttonStyle };
            ...
            buttonGrid.Children.Add(testButton, 0, 2);
            ...
            testButton.Clicked += OnShareClicked;
        ...
        private void OnShareClicked()
        {
			...
			CrossShare.Current.Share(new ShareMessage
			{
				...
				Text = "I made a sweet song in Drumbot!",
